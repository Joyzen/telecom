...
public class DatabaseConfiguration implements EnvironmentAware { 
    ...
    @Bean public SqlSessionFactory sqlSessionFactory() throws Exception { 
      ...
      sqlSessionFactoryBean.setTypeAliasesPackage("org.lanqiao.bean");
      //mybatis分页 
      ...
      sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath:/org/lanqiao/mapper/*.xml")); 
