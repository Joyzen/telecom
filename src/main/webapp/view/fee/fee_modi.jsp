    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function showResult() {
            	...
            	if(validata()){
	            	$.ajax({
	            		url:"${pageContext.request.contextPath }/tariff/doModi.do",
            ...
            $(function(){
            	feeTypeChange(${modiTariff.tariffType});
            })
        </script>
    </head>
    <body>
        ...
        <div id="main">            
            ...
            <form action="" method="" class="main_form">
                ...
                <div class="input_info"><input type="text" class="readonly" readonly value="${modiTariff.tariffId }" name="tariffId" /></div>
                <div class="text_info clearfix"><span>资费名称：</span></div>
                <div class="input_info">
                    <input id="tariffName" type="text" class="width300" value="${modiTariff.tariffName }" name="tariffName"/>
                    <span class="required">*</span>
                    <div id="tariffNameMsg" class="validate_msg_short">50长度的字母、数字、汉字和下划线的组合</div>
                </div>
                <div class="text_info clearfix"><span>资费类型：</span></div>
                <div class="input_info fee_type">
                    <input type="radio" ${modiTariff.tariffType==1?"checked":"" } name="tariffType" value="1" id="monthly" onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" ${modiTariff.tariffType==2?"checked":"" } name="tariffType" value="2" checked="checked" id="package" onclick="feeTypeChange(2);" />
                    <label for="package">套餐</label>
                    <input type="radio" ${modiTariff.tariffType==3?"checked":"" } name="tariffType" value="3" id="timeBased" onclick="feeTypeChange(3);" />
                    <label for="timeBased">计时</label>
                </div>
                <div class="text_info clearfix"><span>基本时长：</span></div>
                <div class="input_info">
                    <input type="text" id="timeLong" name="timeLong" value="${modiTariff.timeLong }" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" id="tariff" name="tariff" value="${modiTariff.tariff }" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" id="timeTariff" name="timeTariff" value="${modiTariff.timeTariff }" class="width100" />
                ...
                <div class="input_info_high">
                    <textarea name="tariffExplain" class="width300 height70">${modiTariff.tariffExplain }
                    </textarea>
